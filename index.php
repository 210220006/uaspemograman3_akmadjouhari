              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                          ...
                          <li class="scroll-to-section"><a href="input_barang.php">Barang</a></li>
                          <li class="scroll-to-section"><a href="input_pelanggan.php">Pelanggan</a></li>
                          <li class="scroll-to-section"><a href="input_transaksi.php">Transaksi</a></li>
                          <li class="has-sub">
                              <a href="javascript:void(0)">Cupcup</a>
                              <ul class="sub-menu">
